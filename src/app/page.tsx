...
const latestNews = [
  {
    ...
    description:
      "Nossa modalidade principal conta com 3 atletas ativos participando de cerca de 2 campeonatos por mês[cite: 37, 39].",
  ...
  },
  {
    ...
    description:
      "Uma iniciativa de incentivo à doação de sangue por jogadores, staff e toda a nossa comunidade[cite: 43, 44].",
  ...
  },
  {
    ...
    description:
      "Realizamos a arrecadação e distribuição de cestas básicas para famílias em situação de vulnerabilidade[cite: 45, 46].",
      ...
      <main className="w-full flex flex-col items-center">
        ...
        <section className="container max-w-6xl px-6 py-16 -mt-12 relative z-10">
          <div className="flex items-center justify-between mb-10">
            ...
            <p className="text-[10px] font-mono text-green-500/50 uppercase tracking-[0.3em]">
              Sussurradores E-Sports
            </p>
          </div>
